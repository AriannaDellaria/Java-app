  ...
  //tramite lo switch trova il label in cui scrivere la domanda inserita precedentemente nell'arraylist
    ...
    void salvaPunteggio(MouseEvent event) {
        ...
        if(utenteCorrente != null && utenteCorrente.getPg3() == 0 && punteggioLocale >= 3) {
    		utenteCorrente.setPg3(0.33); //punteggio globale incrementato solo se viene superato l'esercizio
    ...
    private TextField getTextField(int i) {
        switch (i) {
            case 1: return text1 ;
