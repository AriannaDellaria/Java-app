...
public class OutputAvanzatoController {
    ...
    void letturaDaFile() {
        ...
        try {
            Scanner scf = new Scanner(new File("DomandeOutputAvanzato.txt"));
    ...
    void salvaPunteggio(MouseEvent event) {
        ...
        if(utenteCorrente != null && utenteCorrente.getPg2() == 0.66 && punteggioLocale >= 3) {
    		utenteCorrente.setPg2(1.0); //punteggio globale incrementato solo se viene superato l'esercizio
